        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 bg-zinc-900 rounded-3xl border border-zinc-800 shadow-lg shadow-black/70 overflow-hidden flex flex-col justify-between">
            ...
            <div className="px-8 pb-8 pt-2">
              <a href="registration">
                <button className="relative w-full overflow-hidden group border-2 border-teal-600 text-teal-600 font-bold py-4 px-8 rounded-xl shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50">
